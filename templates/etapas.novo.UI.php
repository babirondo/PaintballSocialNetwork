...
<FORM ACTION="{{FormACtion}}" method="POST">
    ...
    <input type="hidden" name="submitted" value="CriarTimeEvento">
                    ...
                    <div class="contact_from_area"  >
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                Championship:  {{autofill.championship}}
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-12">
                                <input type="text" name="evento" value="{{autofill.evento}}" placeholder="Event name" >
                            </div>
                        </div>

                        <div class="row">
                            <div class="form-group col-md-12">
                                <input type="submit"   value=" {{botao_salvar}} "  >
